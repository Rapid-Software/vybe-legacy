...
export const HomeFirstHero : React.FC<HomeFirstHeroProps> = () => {
    return (
        ...
        <div className="mt-6 text-xl font-light text-true-gray-500 antialiased">Refresh your playlists with music taylored to your ears!</div>
        <button className="mt-6 px-8 py-4 rounded-full font-normal tracking-wide bg-gradient-to-b from-yellow-600 to-red-700 text-white outline-none focus:outline-none hover:shadow-lg hover:from-blue-700 transition duration-200 ease-in-out">
          Download Now
        </button>
      </div>
