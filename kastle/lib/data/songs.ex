defmodule Data.Songs do
    ...
    # Mutation Functions
    defdelegate add_song(type, pid, name, artist, artist_id, image, playbackurl), to: Data.Mutations.Songs

    defdelegate find_or_create(type, pid, name, artist, artist_id, image, playbackurl), to: Data.Mutations.Songs #if,else this.add_song
    # Query Functions
end
