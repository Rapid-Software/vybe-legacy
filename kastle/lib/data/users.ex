defmodule Data.Users do
    ...
    defdelegate add_liked_song(id, sid, type, pid, artist, name, image, playbackurl), to: Data.Mutations.Users
    defdelegate add_rejected_song(id, sid, type, pid, artist, name, image, playbackurl), to: Data.Mutations.Users
